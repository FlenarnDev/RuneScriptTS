...
import { SymbolType } from "../../../runescript-compiler/symbol/SymbolType";
...
import { ExpressionGenerator } from "../../util/ExpressionGenerator ";
...
export class DumpCommandHandler implements DynamicCommandHandler {
        ...
        if (context.arguments.length === 0) {
            ...
            context.arguments.forEach((arg, i) => {
                ...
                if (type instanceof TupleType) {
                    ...
                    type.baseType !== BaseVarType.INTEGER &&
                    type.baseType !== BaseVarType.STRING
                ) {
    ...
    private typeToString(context: CodeGeneratorContext, type: Type): void {
        ...
        const conversionSymbol = context.rootTable.find(
            SymbolType.serverScript(CommandTrigger),
